...
import { openDaily, closeDaily, toggleDailyMaximize, dailyPrev, dailyNext, handleDailyKey, openDailyForSprint, filterDailyItems, openDailyBugs, closeDailyBugs, closeDailyBugsOverlay, toggleDailyBugsAll } from './modules/daily.js';
...
window.openDailyBugs     = openDailyBugs;
window.closeDailyBugs    = closeDailyBugs;
window.closeDailyBugsOverlay = closeDailyBugsOverlay;
window.toggleDailyBugsAll = toggleDailyBugsAll;
