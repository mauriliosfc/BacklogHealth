...
|---|---|---|
| **Instalador** | [Backlog Health Setup 1.1.2.exe](https://github.com/mauriliosfc/BacklogHealth/releases/download/v1.1.2/Backlog.Health.Setup.1.1.2.exe) | Uso diário — cria atalho no Desktop e Menu Iniciar |
| **Portátil** | [Backlog Health 1.1.2.exe](https://github.com/mauriliosfc/BacklogHealth/releases/download/v1.1.2/Backlog.Health.1.1.2.exe) | Sem instalar — execute direto |
