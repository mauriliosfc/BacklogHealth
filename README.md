...
|---|---|---|
| **Instalador** | [Backlog Health Setup 1.1.3.exe](https://github.com/mauriliosfc/BacklogHealth/releases/download/v1.1.3/Backlog.Health.Setup.1.1.3.exe) | Uso diário — cria atalho no Desktop e Menu Iniciar |
| **Portátil** | [Backlog Health 1.1.3.exe](https://github.com/mauriliosfc/BacklogHealth/releases/download/v1.1.3/Backlog.Health.1.1.3.exe) | Sem instalar — execute direto |
